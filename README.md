...
**`-i all`** calculates hbonds, ionic, hydrophobic, ring_stacking interactions. You also have option to calculate intra-monomer interactions with **`-intra True`** flag. 
```
